...
B:"ytp-mdx-popup-dialog",N:{role:"dialog"},G:[{D:"div",B:"ytp-mdx-popup-dialog-inner-content",G:[{D:"div",B:"ytp-mdx-popup-title",mI:"You're signed out"},{D:"div",B:"ytp-mdx-popup-description",mI:"Videos that you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{D:"div",B:"ytp-mdx-privacy-popup-buttons",G:[{D:"button",O1:["ytp-button","ytp-mdx-privacy-popup-cancel"],mI:"Cancel"},{D:"button",O1:["ytp-button",
...
break;case -1:this.Vr(new g.tN(64));break;case -1E3:this.Vr(new g.tN(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback.",hc:2}))}q=Bs(this.wY).trackData;var J=this.W;(q||J?q&&J&&q.trackName==J.trackName&&q.languageCode==J.languageCode&&q.languageName==J.languageName&&q.kind==J.kind:1)||(this.W=q,BfZ(this,q));q=Bs(this.wY);q.volume===-1||Math.round(this.U.getVolume())===q.volume&&this.U.isMuted()===q.muted||this.Vg.isActive()||this.bd()}else O$M(this)};
